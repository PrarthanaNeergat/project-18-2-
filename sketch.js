...
var ground,scene,sceneImage,scene2,sceneImage3,scene3;
var PLAY = 1;
var END = 0;
var gameState = PLAY;
var score= 0;
...
scene3Image=loadImage("jungleCopy.jpg");
...
function setup() {
  ...
  scene2=createSprite(1500,200,400,400);
  scene3=createSprite(1500,200,400,400);
  scene3.addImage("scene3",scene3Image);
...
function draw() {
  ...
  if(gameState===PLAY){
    ...
    scene2.visible=false;
     ...
     scene3.velocityX=-(6 + 3*score/100);
